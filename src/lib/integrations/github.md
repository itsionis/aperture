...
Fetches releases from `apertureConfig.GITHUB_CHANGELOG_REPO` using GitHub's REST releases endpoint, decodes the response with Zod, and maps it to sidebar/dialog-ready changelog entries.
